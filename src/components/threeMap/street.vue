  ...
  export default {
    ...
    methods: {
      init() {
        ...
        //初始化相机
        this.camera = new THREE.PerspectiveCamera(this.fov, window.innerWidth / window.innerHeight, 100, 500);
      ...
      addObj() {
        //包含材质
        new MTLLoader().setPath('/static/model/street/').load('Street environment_V01.mtl', materials => {
          console.log("materials", materials);
          materials.preload();
          new OBJLoader().setMaterials(materials).setPath('/static/model/street/').load('Street environment_V01.obj', obj => {
